...
{   
    public function atualizar(Request $request) {
        CadCategoria::where("id", $request->input("id"))->update(["descricao" => $request->input("descricao"), "slug" => StringHelper::criarSlug($request->input("descricao")), "updated_at" => date("Y-m-d H:i:s")]);
    ...
    public function salvar(Request $request) {
        CadCategoria::create(["descricao" => $request->input("descricao"), "slug" => StringHelper::criarSlug($request->input("descricao")), "created_at" => date("Y-m-d H:i:s"), "updated_at" => date("Y-m-d H:i:s")]);
