...
<aside class="bg-p-navegacao--{{$blog->aparencia->temanavegacao->slug}}" id="navegacaoOpcoes">
    <ul class="bg-p-navegacao__lista" role="menubar">
        ...
        <li class="bg-p-navegacao__item" role="menuitem"><a class="bg-p-navegacao__link" href="/painel/configuracoes"><i class="icon-cog-alt bg-p-navegacao__icone"></i>&nbsp;@lang("messages.menu.configuracoes")</a></li>
 ...
 <aside class="bg-p-usuario--{{$blog->aparencia->temaperfil->slug}}" data-animacao-situacao="desanimado" id="perfilUsuario">
    ...
    <ul class="bg-p-usuario__opcoes">
        ...
        <li class="bg-p-usuario__opcoes___opcao"><a class="bg-p-usuario__opcoes___link" href="/painel/configuracoes"><i class="icon-cog bg-p-usuario__opcoes___icone"></i>&nbsp;@lang("messages.menu.perfil.conta")</a></li>
    </ul> 
</aside> 