...
@section("pagina", "Posts - Rascunhos")
@section("conteudo")
    <div class="bg-p-dashboard__header">
        <div class="o-breadcrumb--arrow">
            ...
            <span class="o-breadcrumb__link"><a class="is-inactive" href="/painel/post/rascunhos" role="link" title="@lang("messages.menu.post.rascunhos")">@lang("messages.menu.post.rascunhos")</a></span>
        </div>
        <a class="o-button--tie o-button--medium" href="/painel/post/formulario"><i class="icon-plus"></i>@lang("messages.botao.novo")</a>
        <form action="/painel/post/rascunhos" class="o-form" id="formpostlistar" method="get" name="formpostlistar" role="search">
