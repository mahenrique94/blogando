...
@section("pagina", "Usuários - Rede social")
@section("conteudo")
    <div class="bg-p-dashboard__header">
        <div class="o-breadcrumb--arrow">
            ...
            <span class="o-breadcrumb__link"><a class="is-inactive" href="/painel/usuarios/rede-social" role="link" title="@lang("messages.menu.usuarios.redesocial")">@lang("messages.menu.usuarios.redesocial")</a></span>
        </div>
        <a class="o-button--tie o-button--medium" href="/painel/usuarios/rede-social/formulario"><i class="icon-plus"></i>@lang("messages.botao.nova")</a>
        <form action="/painel/usuarios/rede-social" class="o-form" id="formpostautorredesocial" method="get" name="formpostautorredesocial" role="search">
    ...
    <table class="c-table--tie c-table--hovered c-table--zebrered c-table--bordered">
        ...
        @forelse ($redessociais as $redesocial)
            <tr>
                ...
                <td style="font-size: 1.1rem;text-align: center;width: 50px;"><a href="/painel/usuarios/rede-social/{{$redesocial->id}}" role="link" title="@lang("messages.botao.editar")"><i class="icon-pencil"></i></a></td>
                <td style="font-size: 1.1rem;text-align: center;width: 50px;"><button formaction="/painel/usuarios/rede-social/{{$redesocial->id}}" onclick="DialogController.build(event, this, requestDelete, 'Deseja confirmar a exclusao', 'icon-trash');" role="button" type="button" style="background: transparent;border: none;" title="@lang("messages.botao.deletar")"><i class="icon-trash"></i></button></td>
            </tr>
        @empty
            <tr>
