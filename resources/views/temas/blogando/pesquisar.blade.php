<div class="bg-aside__caixa bg-aside__caixa--redessociais">
    ...
    <form action="/procurar" class="bg-pesquisar o-form" id="formpesquisarpost" method="get" name="formpesquisarpost">
        <div class="o-form__group">
            <input aria-required="true" class="o-form__data bg-pesquisar__data" id="filtro" name="filtro" placeholder="Digite aqui o título ou uma parte dele" required type="search" value="{{isset($filtro) && !is_null($filtro) && !empty($filtro) ? $filtro : null}}">
